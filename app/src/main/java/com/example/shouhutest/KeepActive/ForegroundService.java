...
import com.example.shouhutest.Util.HttpUtil;
...
public class ForegroundService extends Service {
    ...
    public void onCreate() {
        ...
        //启动后台定位
        locationClient.enableBackgroundLocation(id, buildNotification());
        startLocation();
...
//        destroyLocation();
    ...
    private AMapLocationClientOption getDefaultOption(){
        ...
        mOption.setInterval(90*1000);//可选，设置定位间隔。默认为2秒
...
//                sb.append("****************").append("\n");
                ...
                try {
                    ...
                    jsonObject.put("Battery", batteryManager.getIntProperty(BatteryManager.BATTERY_PROPERTY_CAPACITY));///当前电量百分比)
                    jsonObject.put("Remark","定位间距一分半");
                    HttpUtil.doPost("http://192.168.1.181:8080/ShouhuTestPI/mi.Main.location.hf",jsonObject.toString(),(response)->{
                        Log.e(TAG, "onLocationChanged: "+response);
                    });
